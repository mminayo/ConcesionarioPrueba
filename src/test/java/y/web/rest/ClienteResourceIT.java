...
import y.repository.ClienteRepository;
import y.service.dto.ClienteDTO;
import y.service.mapper.ClienteMapper;
...
class ClienteResourceIT {
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente().dni(DEFAULT_DNI).name(DEFAULT_NAME).numeroCompras(DEFAULT_NUMERO_COMPRAS).tier(DEFAULT_TIER);
        return cliente;
    }
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        Cliente cliente = new Cliente().dni(UPDATED_DNI).name(UPDATED_NAME).numeroCompras(UPDATED_NUMERO_COMPRAS).tier(UPDATED_TIER);
        return cliente;
    }
    ...
    void putNewCliente() throws Exception {
        ...
        updatedCliente.dni(UPDATED_DNI).name(UPDATED_NAME).numeroCompras(UPDATED_NUMERO_COMPRAS).tier(UPDATED_TIER);
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.dni(UPDATED_DNI).name(UPDATED_NAME).numeroCompras(UPDATED_NUMERO_COMPRAS).tier(UPDATED_TIER);
