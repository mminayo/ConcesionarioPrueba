...
class CocheResourceIT {
    ...
    private static final String DEFAULT_TRANSPUESTO = "AAAAAAAAAA";
    private static final String UPDATED_TRANSPUESTO = "BBBBBBBBBB";
    ...
    public static Coche createEntity(EntityManager em) {
        Coche coche = new Coche()
            ...
            .transpuesto(DEFAULT_TRANSPUESTO);
        return coche;
    }
    ...
    public static Coche createUpdatedEntity(EntityManager em) {
        Coche coche = new Coche()
            ...
            .transpuesto(UPDATED_TRANSPUESTO);
        return coche;
    }
    ...
    void createCoche() throws Exception {
        ...
        assertThat(testCoche.getTranspuesto()).isEqualTo(DEFAULT_TRANSPUESTO);
    }
    ...
    void getAllCoches() throws Exception {
        ...
        restCocheMockMvc
            ...
            .andExpect(jsonPath("$.[*].transpuesto").value(hasItem(DEFAULT_TRANSPUESTO)));
    }
    ...
    void getCoche() throws Exception {
        ...
        restCocheMockMvc
            ...
            .andExpect(jsonPath("$.transpuesto").value(DEFAULT_TRANSPUESTO));
    }
    ...
    void putNewCoche() throws Exception {
        ...
        assertThat(testCoche.getTranspuesto()).isEqualTo(UPDATED_TRANSPUESTO);
    }
    ...
    void partialUpdateCocheWithPatch() throws Exception {
        ...
        partialUpdatedCoche.modelo(UPDATED_MODELO).transpuesto(UPDATED_TRANSPUESTO);
